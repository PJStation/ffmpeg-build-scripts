...
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libfreetype"

# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libfontconfig"
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libfribidi"
# export COMMON_FF_CFG_FLAGS="$COMMON_FF_CFG_FLAGS --enable-libass"
